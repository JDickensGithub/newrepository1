...
# function to print x raised to the power y  x^y
...
# Assign the expression, data_frame$c1, to a variable for easier
...
if ymd("2021-10-01") < now() {
   print("We do not have enough time")
   else if now()<(ymd("2021-10-01"))< (ymd("2021-10-01"))
...
# the median of each column.
 ...
 # we wamt the median for each column
 # method 1  
